  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: p.bg, color: p.icon,
        display: 'grid', placeItems: 'center', flexShrink: 0,
        border: `1px solid ${p.border}`
      }}>
        <Icon name={item.kind === 'parts' ? 'package' : 'wrench'} size={18} color={p.icon} />
      </div>
...
function VehicleHeader({ ro }) {
  return (
    <div style={{
      ...
      border: '1px solid #0D1E2E', backgroundPosition: "0% 0%", backgroundRepeat: "repeat", backgroundAttachment: "scroll", backgroundImage: "none", backgroundSize: "auto", backgroundOrigin: "padding-box", backgroundClip: "border-box"
    }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{
